...
Requires two public subets. Currently takes the first two public subnets and no more.
...
| [asg](/docs/compute/module_asg/doc.md) | [/modules/compute/asg/](/modules/compute/asg/) | asg to create the instances and has alarms for autoscaling |
...
| alb_arn | arn of the alb to use in other modules |
| alb_dns_name | useful to route traffic |
| target_group_arn_suffix | tg suffix arn for linking instances and general use |
| alb_arn_suffix | arn suffix of the alb for use in other modules |
